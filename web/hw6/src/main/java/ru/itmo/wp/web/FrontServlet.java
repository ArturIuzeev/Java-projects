...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method method_before = getMethod(pageClass, "before");
        Method method_after = getMethod(pageClass, "after");
        ...
        try {
            ...
            method_before.setAccessible(true);
            method_after.setAccessible(true);

            method_before.invoke(page, request, view);
            method.invoke(page, request, view);
            method_after.invoke(page, request, view);
